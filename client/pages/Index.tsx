  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active ? "bg-neutral-100 border-neutral-300 text-foreground font-bold dark:bg-neutral-800 dark:border-neutral-700 dark:text-white" : "text-neutral-700 hover:bg-neutral-100 border-neutral-200 font-semibold dark:text-neutral-200 dark:hover:bg-neutral-800 dark:border-neutral-800",
      )}
    >
