...
public class ParticipantsController implements Initializable, I18nController {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        updateTexts();
        logger.debug("ParticipantsController initialized");
    }
    ...
    public void updateTexts() {
        ...
        placeholderLabel.setText(i18n.getText("participantsPlaceholder", "Participant management functionality coming soon."));
    }
}
